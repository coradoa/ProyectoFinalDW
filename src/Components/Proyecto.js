        ...
        <div> {/*Crea un contenedor principal */} 
           <div class="github-container"> {/* Contenedor con la clase CSS 'github-container' */}
                ...
                <section class="github-container"> {/*Sección con la clase CSS 'github-container' */} 
                    ...
                    <a href="https://github.com/coradoa/Proyecto-contenedor-de-youtube" class="github-link"> {/* Enlace al repositorio de GitHub*/}
                ...
                <section class="github-container"> {/*Otra sección con la clase CSS 'github-container' */}
                    ...
                    <a href="https://github.com/coradoa/Proyecto-MongoDB" class="github-link"> {/* Enlace al repositorio de GitHub */}
                ...
                <section class="github-container"> {/*Otra sección con la clase CSS 'github-container' */} 
                    ...
                    <a href="https://github.com/coradoa/Proyecto-de-publicaci-n-de-instagram" class="github-link"> {/* Enlace al repositorio de GitHub */}
